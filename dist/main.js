...
var _events = __webpack_require__(/*! ./events */ "./src/compiler/codegen/events.js");

var _index = __webpack_require__(/*! ../directives/index */ "./src/compiler/directives/index.js");

var _index2 = _interopRequireDefault(_index);

var _util = __webpack_require__(/*! shared/util */ "./src/shared/util.js");

var _helpers = __webpack_require__(/*! ../helpers */ "./src/compiler/helpers.js");
...
exports.CodegenState = function CodegenState(options) {
...
var _errorDetector = __webpack_require__(/*! ./error-detector */ "./src/compiler/error-detector.js");

var _toFunction = __webpack_require__(/*! ./to-function */ "./src/compiler/to-function.js");
    ...
    function compile(template, options) {
      ...
      if (options) {
        ...
        if (options.directives) {
          finalOptions.directives = (0, _util.extend)(Object.create(baseOptions.directives || null), options.directives);
        }
        // copy other options
...
var _on = __webpack_require__(/*! ./on */ "./src/compiler/directives/on.js");

var _on2 = _interopRequireDefault(_on);

var _bind = __webpack_require__(/*! ./bind */ "./src/compiler/directives/bind.js");
...
var _index = __webpack_require__(/*! core/util/index */ "./src/core/util/index.js");
...
var _index = __webpack_require__(/*! ./parser/index */ "./src/compiler/parser/index.js");
...
var _filterParser = __webpack_require__(/*! ./parser/filter-parser */ "./src/compiler/parser/filter-parser.js");
...
function addHandler(el, name, value, modifiers, important, warn) {
  modifiers = modifiers || _util.emptyObject;
  ...
  if (modifiers !== _util.emptyObject) {
...
var _optimizer = __webpack_require__(/*! ./optimizer */ "./src/compiler/optimizer.js");

var _index2 = __webpack_require__(/*! ./codegen/index */ "./src/compiler/codegen/index.js");

var _createCompiler = __webpack_require__(/*! ./create-compiler */ "./src/compiler/create-compiler.js");
...
var _util2 = __webpack_require__(/*! web/compiler/util */ "./src/platforms/web/compiler/util.js");
...
var _textParser = __webpack_require__(/*! ./text-parser */ "./src/compiler/parser/text-parser.js");

var _filterParser = __webpack_require__(/*! ./filter-parser */ "./src/compiler/parser/filter-parser.js");

var _model = __webpack_require__(/*! ../directives/model */ "./src/compiler/directives/model.js");

var _util = __webpack_require__(/*! shared/util */ "./src/shared/util.js");

var _env = __webpack_require__(/*! core/util/env */ "./src/core/util/env.js");
  ...
  (0, _htmlParser.parseHTML)(template, {
    ...
    start: function start(tag, attrs, unary) {
      ...
      if (isForbiddenTag(element) && !(0, _env.isServerRendering)()) {
        ...
        "development" !== 'production' && warn('Templates should only be responsible for mapping the state to the ' + 'UI. Avoid placing tags with side-effects in your templates, such as ' + ('<' + tag + '>') + ', as they will not be parsed.');
      }
...
function makeAttrsMap(attrs) {
  ...
  for (var i = 0, l = attrs.length; i < l; i++) {
    if ("development" !== 'production' && map[attrs[i].name] && !_env.isIE && !_env.isEdge) {
...
var _debug = __webpack_require__(/*! core/util/debug */ "./src/core/util/debug.js");
...
var _index = __webpack_require__(/*! ./instance/index */ "./src/core/instance/index.js");
...
var inWeex = exports.inWeex = false;
var weexPlatform = exports.weexPlatform = false;
...
var _helpers = __webpack_require__(/*! compiler/helpers */ "./src/compiler/helpers.js");
...
var _model = __webpack_require__(/*! ./model */ "./src/platforms/web/compiler/directives/model.js");

var _model2 = _interopRequireDefault(_model);

var _text = __webpack_require__(/*! ./text */ "./src/platforms/web/compiler/directives/text.js");

var _text2 = _interopRequireDefault(_text);

var _html = __webpack_require__(/*! ./html */ "./src/platforms/web/compiler/directives/html.js");
...
var _config = __webpack_require__(/*! core/config */ "./src/core/config.js");

var _config2 = _interopRequireDefault(_config);

var _helpers = __webpack_require__(/*! compiler/helpers */ "./src/compiler/helpers.js");

var _model = __webpack_require__(/*! compiler/directives/model */ "./src/compiler/directives/model.js");
...
var _options = __webpack_require__(/*! ./options */ "./src/platforms/web/compiler/options.js");
...
var _textParser = __webpack_require__(/*! compiler/parser/text-parser */ "./src/compiler/parser/text-parser.js");
...
var _class = __webpack_require__(/*! ./class */ "./src/platforms/web/compiler/modules/class.js");

var _class2 = _interopRequireDefault(_class);

var _style = __webpack_require__(/*! ./style */ "./src/platforms/web/compiler/modules/style.js");

var _style2 = _interopRequireDefault(_style);

var _model = __webpack_require__(/*! ./model */ "./src/platforms/web/compiler/modules/model.js");

var _model2 = _interopRequireDefault(_model);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = [_class2.default, _style2.default, _model2.default];
...
var _index = __webpack_require__(/*! compiler/parser/index */ "./src/compiler/parser/index.js");
...
var _style = __webpack_require__(/*! web/util/style */ "./src/platforms/web/util/style.js");
...
var _index = __webpack_require__(/*! ../util/index */ "./src/platforms/web/util/index.js");

var _index2 = __webpack_require__(/*! ./modules/index */ "./src/platforms/web/compiler/modules/index.js");

var _index3 = _interopRequireDefault(_index2);

var _index4 = __webpack_require__(/*! ./directives/index */ "./src/platforms/web/compiler/directives/index.js");

var _index5 = _interopRequireDefault(_index4);

var _util = __webpack_require__(/*! shared/util */ "./src/shared/util.js");

var _util2 = __webpack_require__(/*! ./util */ "./src/platforms/web/compiler/util.js");
...
var _index = __webpack_require__(/*! ./runtime/index */ "./src/platforms/web/runtime/index.js");

var _index2 = _interopRequireDefault(_index);

var _index3 = __webpack_require__(/*! ./util/index */ "./src/platforms/web/util/index.js");

var _index4 = __webpack_require__(/*! ./compiler/index */ "./src/platforms/web/compiler/index.js");

var _compat = __webpack_require__(/*! ./util/compat */ "./src/platforms/web/util/compat.js");
...
_index2.default.compile = _index4.compileToFunctions;
...
exports.shouldDecodeNewlinesForHref = exports.shouldDecodeNewlines = undefined;
...
var shouldDecodeNewlines = exports.shouldDecodeNewlines = _index.inBrowser ? getShouldDecode(false) : false;
// #6828: chrome encodes content in a[href]
var shouldDecodeNewlinesForHref = exports.shouldDecodeNewlinesForHref = _index.inBrowser ? getShouldDecode(true) : false;
...
var LIFECYCLE_HOOKS = exports.LIFECYCLE_HOOKS = ['beforeCreate', 'created', 'beforeMount', 'mounted', 'beforeUpdate', 'updated', 'beforeDestroy', 'destroyed', 'activated', 'deactivated', 'errorCaptured'];
 ...
 */
var isReservedAttribute = exports.isReservedAttribute = makeMap('key,ref,slot,slot-scope,is');
...
var bind = exports.bind = Function.prototype.bind ? nativeBind : polyfillBind;
